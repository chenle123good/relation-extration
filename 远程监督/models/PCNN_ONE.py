...
class PCNN_ONE(BasicModule):
    ...
    def __init__(self, opt):
        ...
        if self.opt.use_pcnn:
            ...
            # mask中文本的位置0，1，2，3，分别被映射成[0, 0, 0], [1, 0, 0], [0, 1, 0], [0, 0, 1]，因此masks的shape为（bag_size, sequence_len, 1, 3）
        ...
        self.init_model_weight()  # 初始化卷积层权重
        self.init_word_emb()  # 初始化词嵌入矩阵、相对于两个实体的位置矩阵
